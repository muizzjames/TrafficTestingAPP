...
import com.adnet.mytraffictestapp.MyApplication;
...
public class SQLiteAssetHelper extends SQLiteOpenHelper {
    ...
    private static final String ASSET_DB_PATH = "song/s1";
...
//            path = MyApplication.dbFolder + File.separator + "ddddd.db";
//            File file = new File(path);
//            Uri video = Uri.parse("android.resource://com.adnet.mytraffictestapp/raw/ddddd.db");
//            file = new File(video.getPath());
//            if(file.exists())
//                Log.e("File", "File is existed");
//            else
//                Log.e("File", "File is not existed");
